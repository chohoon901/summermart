...
public class ProdController {
    ...
    @ResponseBody
    public String selectedProd() throws Exception {
        ...
        for (int i = 0; i<selectedProdList.size(); i++) {
            ...
            nvps.add(new BasicNameValuePair("PROD", prodName ));
            ...
            for (int j = 0; j < jsonArray.length(); j++) {
                ...
                String recommendProd = (String)jsonArray.get(j);

//                Prod recommendedProd = repository.findProd("word");

//                recommendProdList.add(recommendedProd);
            }
